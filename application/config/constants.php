...
define('PROJECT_NAME', 'Bet60');
define('COMPANY_NAME', 'Bet60');
define('SUPERADMIN', 0);
define('KEY', '2018');
...
define('SUB_ADMIN_MANAGEMENT', false);
define('AGENT', false);
...
define('INCOME_DEPOSIT_BONUS', true);
define('INCOME_BET_BONUS', true);
define('INCOME_DAILY_SALARY_BONUS', true);
define('INCOME_DAILY_ATTENDANCE_BONUS', true);
define('REPORT', true);
...
define('AB','Ander Bahar');
define('ABP','Ander Bahar Plus');
