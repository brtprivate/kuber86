...
class DragonTiger extends REST_Controller
{
    ...
    public function place_bet_post()
    {
        ...
        $dragon_total_bet_amount = $this->DragonTiger_model->get_dragon_total_bet($this->data['user_id'],$this->data['game_id']);
        $tiger_total_bet_amount = $this->DragonTiger_model->get_tiger_total_bet($this->data['user_id'],$this->data['game_id']);
        $tie_total_bet_amount = $this->DragonTiger_model->get_tie_total_bet($this->data['user_id'],$this->data['game_id']);
    ...
    public function get_total_bet_amount_post()
    {
        ...
        if($dragon_total_bet_amount || $tiger_total_bet_amount || $tie_total_bet_amount){
            $data['message'] = 'Success';
            $data['dragon_total_bet_amount'] = $dragon_total_bet_amount ?? '';
            $data['tiger_total_bet_amount'] = $tiger_total_bet_amount ?? '';
            $data['tie_total_bet_amount'] = $tie_total_bet_amount ?? '';
            $data['code'] = HTTP_OK;
            $this->response($data, HTTP_OK);
            exit();
        } else {
