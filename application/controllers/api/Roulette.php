...
class Roulette extends REST_Controller
{
    ...
    public function get_active_game_socket_post()
    {
        ...
        if ($game_data) {
           ...
           $data['online_users'] = $this->Roulette_model->getRoomOnlineUser($this->data['room_id']);
           $data['online'] = min(rand(300, 1050), 1350); 
    ...
    public function cancel_bet_post()
    {
        ...
        if ($this->Roulette_model->DeleteBet($bet[0]->id, $this->data['user_id'], $this->data['game_id'])) {
            $this->Roulette_model->AddWallet($this->data['user_id'], $bet[0]->amount);
    ...
    public function get_result_post()
    {
        ...
        if($data['diff_amount']< 0){
            ...
            $this->Roulette_model->MinusWallet($this->data['user_id'], $data['diff_amount']);
