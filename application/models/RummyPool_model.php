...
class RummyPool_model extends MY_Model
{
    public function AllGames($startDate = null, $endDate = null)
    {
        ...
        if ($startDate !== null && $endDate !== null) {
            ...
            $this->db->where('tbl_rummy.added_date >=', $startDate); // Prefix 'added_date' with 'tbl_rummy.'
            $this->db->where('tbl_rummy.added_date <=', $endDate); // Prefix 'added_date' with 'tbl_rummy.'
        }
