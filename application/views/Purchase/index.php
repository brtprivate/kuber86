...
<div class="row">
    <div class="col-12">
        <ul class="nav nav-tabs" id="paymentTabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="autoPayment-tab" data-toggle="tab" href="#autoPayment" role="tab" aria-controls="autoPayment" aria-selected="true">Auto Payment</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="manualPayment-tab" data-toggle="tab" href="#manualPayment" role="tab" aria-controls="manualPayment" aria-selected="false">Manual Payment</a>
            </li>
        </ul>
        <div class="tab-content" id="paymentTabsContent">
            <div class="tab-pane fade show active" id="autoPayment" role="tabpanel" aria-labelledby="autoPayment-tab">
                <div class="card">
                    <div class="card-body">
            ...
            <div class="tab-pane fade" id="manualPayment" role="tabpanel" aria-labelledby="manualPayment-tab">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                        ...
                                        <table class="table table-bordered"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $Data->user_id ?></td>
                                                    <td><?= $Data->utr ?></td>
                                                    <td><img src="<?= base_url('uploads/data/transaction/' . $Data->photo) ?>" alt="Transaction Photo" width="200" height="200"></td>
                                                    <td><?= $Data->price ?></td>
                                                    <td>
