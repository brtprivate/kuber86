                    ...
                    <tbody>
                        ...
                        foreach($AllAgent as $agent) { ?> 
                            ...
                            <span class="fa fa-eye"></span></a>
                                | <a href="<?= base_url('backend/user/LadgerReports/' . $agent->id) ?>" class="btn btn-info"
                                data-toggle="tooltip" data-placement="top" title="View Ladger Report"><span class="ti-wallet"></span></a>
                        | <a href="<?= base_url('backend/AgentUser/edit_wallet/' . $agent->id) ?>" class="btn btn-info"
                            data-toggle="tooltip" data-placement="top" title="Add Wallet"><span
                                class="fa fa-credit-card" ></span></a>

                        | <a href="<?= base_url('backend/AgentUser/deduct_wallet/' . $agent->id) ?>" class="btn btn-danger"
                            data-toggle="tooltip" data-placement="top" title="Deduct Wallet"><span
                                class="fa fa-credit-card" ></span></a>

                                | <a href="<?= base_url('backend/AgentUser/edit_user/' . $agent->id) ?>" class="btn btn-info"
