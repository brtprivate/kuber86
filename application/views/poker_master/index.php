                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?= base_url('data/post/' . $PokerMaster->image) ?>" width="100px" height="100px"></td>
                            <td><img src="<?= base_url('data/post/' . $PokerMaster->image_bg) ?>" width="100px" height="100px"></td>
